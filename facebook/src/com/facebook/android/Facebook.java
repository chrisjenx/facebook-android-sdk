...
public class Facebook
{
     ...
     * See authorize() below for @params.
     */
    public boolean authorize(Activity activity, String[] permissions, final DialogListener listener)
    {
        return authorize(activity, permissions, DEFAULT_AUTH_ACTIVITY_CODE, listener);
    }
     ...
     *            canceled.
     */
    public boolean authorize(Activity activity, String[] permissions, int activityCode,
    ...
    private boolean validateAppSignatureForPackage(Context context, String packageName)
    {
        ...
        {
            if (signature.toCharsString().equals(getFacebookAppSignature()))
            {
                return true;
            }
        }
        ...
        if (requestCode == mAuthActivityCode)
        {
            ...
            else if (resultCode == Activity.RESULT_CANCELED)
            {
                ...
                if (data != null)
                {
                    ...
                    mAuthDialogListener.onError(new DialogError(data.getStringExtra("error"), data
    ...
    public boolean extendAccessToken(Context context, ServiceListener serviceListener)
    {
        ...
        return context.bindService(intent, new TokenRefreshServiceConnection(context,
                serviceListener), Context.BIND_AUTO_CREATE);
    }
     ...
     * @return JSON string representation of the response
     */
    public String request(String graphPath, Bundle params, String httpMethod, InputStream upload,
            String uploadName) throws FileNotFoundException, MalformedURLException, IOException
    {
    ...
    public void setAccessExpiresIn(String expiresIn)
    {
        if (expiresIn != null)
        {
            long expires = expiresIn.equals("0") ? 0 : System.currentTimeMillis()
                    + Long.parseLong(expiresIn) * 1000L;
    ...
    static String getFacebookAppSignature()
    {
        StringBuilder sb = new StringBuilder(
                "30820268308201d102044a9c4610300d06092a864886f70d0101040500307a310");
        sb.append("b3009060355040613025553310b30090603550408130243413112301006035504");
        sb.append("07130950616c6f20416c746f31183016060355040a130f46616365626f6f6b204");
        sb.append("d6f62696c653111300f060355040b130846616365626f6f6b311d301b06035504");
        sb.append("03131446616365626f6f6b20436f72706f726174696f6e3020170d30393038333");
        sb.append("13231353231365a180f32303530303932353231353231365a307a310b30090603");
        sb.append("55040613025553310b30090603550408130243413112301006035504071309506");
        sb.append("16c6f20416c746f31183016060355040a130f46616365626f6f6b204d6f62696c");
        sb.append("653111300f060355040b130846616365626f6f6b311d301b06035504031314466");
        sb.append("16365626f6f6b20436f72706f726174696f6e30819f300d06092a864886f70d01");
        sb.append("0101050003818d0030818902818100c207d51df8eb8c97d93ba0c8c1002c928fa");
        sb.append("b00dc1b42fca5e66e99cc3023ed2d214d822bc59e8e35ddcf5f44c7ae8ade50d7");
        sb.append("e0c434f500e6c131f4a2834f987fc46406115de2018ebbb0d5a3c261bd97581cc");
        sb.append("fef76afc7135a6d59e8855ecd7eacc8f8737e794c60a761c536b72b11fac8e603");
        sb.append("f5da1a2d54aa103b8a13c0dbc10203010001300d06092a864886f70d010104050");
        sb.append("0038181005ee9be8bcbb250648d3b741290a82a1c9dc2e76a0af2f2228f1d9f9c");
        sb.append("4007529c446a70175c5a900d5141812866db46be6559e2141616483998211f4a6");
        sb.append("73149fb2232a10d247663b26a9031e15f84bc1c74d141ff98a02d76f85b2c8ab2");
        sb.append("571b6469b232d8e768a7f7ca04f7abe4a775615916c07940656b58717457b42bd");
        sb.append("928a2");
        return sb.toString();
    }
